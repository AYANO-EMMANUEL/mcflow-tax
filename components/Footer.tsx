        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/guides" className="text-green-700 hover:text-green-600 transition-colors">
                  Guides
                </Link>
              </li>
              <li>
                <Link href="/api-reference" className="text-green-700 hover:text-green-600 transition-colors">
                  API Reference
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/about" className="text-green-700 hover:text-green-600 transition-colors">
                  About
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-green-700 hover:text-green-600 transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
