      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-zinc dark:prose-invert max-w-none">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 mb-4">What We Offer</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                  <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-2">API Platform</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">
                    RESTful API with comprehensive documentation, SDKs, and developer tools for seamless integration.
                  </p>
                </div>
                <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                  <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-2">FIRS Compliance</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">
                    Full compliance with Nigerian tax regulations and FIRS E-Invoicing System standards.
                  </p>
                </div>
                <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                  <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Developer Tools</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">
                    Comprehensive SDKs, webhooks, and tools designed with developers in mind.
                  </p>
                </div>
                <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                  <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Enterprise Support</h3>
                  <p className="text-zinc-600 dark:text-zinc-400">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 mb-4">Why Choose mcflow?</h2>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                  <h3 className="font-semibold text-zinc-900 dark:text-zinc-50 mb-2">General Inquiries</h3>
                  <a href="mailto:hello@mcflow.ng" className="text-green-600 dark:text-green-400 hover:underline">
                    hello@mcflow.ng
                  </a>
                </div>
                <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                  <h3 className="font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Developer Support</h3>
                  <a href="mailto:dev@mcflow.ng" className="text-green-600 dark:text-green-400 hover:underline">
                    dev@mcflow.ng
                  </a>
                </div>
                <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                  <h3 className="font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Sales</h3>
            ...
            <div className="p-6 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg">
              <h3 className="font-semibold text-zinc-900 dark:text-zinc-50 mb-4">Ready to get started?</h3>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/guides"
                  className="px-6 py-3 bg-zinc-900 dark:bg-zinc-50 text-white dark:text-zinc-900 rounded-lg font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors text-center"
                >
                  View Documentation
                </Link>
                <Link
                  href="/pricing"
                  className="px-6 py-3 border border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-50 rounded-lg font-medium hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors text-center"
                >
                  See Pricing
                </Link>
              </div>
