    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-900 rounded-full mb-6">
            <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
            <span className="text-sm text-green-700 dark:text-green-400 font-medium">API v2.0 Available</span>
          </div>
          <h1 className="text-5xl sm:text-6xl font-bold text-zinc-900 dark:text-zinc-50 mb-6 leading-tight">
            Integrate with Nigeria&apos;s
            <span className="block text-green-600 dark:text-green-400">Tax Platform</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-green-500 dark:hover:border-green-500 transition-colors">
            <div className="w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-2">FIRS Compliant</h3>
          ...
          <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-green-500 dark:hover:border-green-500 transition-colors">
            ...
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-2">RESTful & Fast</h3>
            <p className="text-zinc-600 dark:text-zinc-400">
          ...
          <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-green-500 dark:hover:border-green-500 transition-colors">
            ...
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Developer First</h3>
            <p className="text-zinc-600 dark:text-zinc-400">
