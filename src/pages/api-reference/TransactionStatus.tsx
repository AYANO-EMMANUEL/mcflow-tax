      ...
      <div className="flex-1 max-w-4xl mx-auto px-8 py-12">
        ...
        <section id="overview" className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Every transaction in the McFlow system has a status that indicates
            its current state in the processing lifecycle. Understanding these
            statuses helps you track and manage your transactions effectively.
          </p>
        </section>
        ...
        <section id="lifecycle" className="mb-12">
          ...
          <div className="mt-6 bg-blue-50 border-l-4 border-blue-500 p-4">
            <p className="text-blue-800 text-sm">
              <strong>Note:</strong> Transactions can also move to{" "}
              <code className="bg-blue-100 px-2 py-1 rounded">failed</code>,
              ...
              states from any point in the lifecycle.
            </p>
          </div>
        </section>
        ...
        <section id="checking-status" className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            You can check the status of any transaction using its ID through the
            appropriate endpoint. The status will be included in the response
            object.
          </p>
          <p className="text-gray-700 leading-relaxed">
            For real-time updates, consider using{" "}
            <a
              href="/api-reference/callback-urls"
              className="text-green-600 hover:text-green-700 underline"
            >
              Callback URLs
            </a>{" "}
            to receive notifications when transaction statuses change.
          </p>
        </section>
      </div>
