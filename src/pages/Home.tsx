      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-green-700 mb-8 leading-relaxed">
            Use <strong>McFlow API</strong> to integrate your system with FIRS
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-6 border-2 border-green-200 rounded-xl hover:border-green-500 bg-green-50/50 transition-colors">
            ...
            <p className="text-green-700">
              Full compliance with Nigerian tax regulations and FIRS E-Invoicing
              System standards. Bank-grade security.
            </p>
          </div>
          <div className="p-6 border-2 border-green-200 rounded-xl hover:border-green-500 bg-green-50/50 transition-colors">
            <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4">
            ...
            <p className="text-green-700">
              RESTful API with OpenAPI specification. 99.9% uptime with
              sub-200ms response times. Built for scale.
            </p>
          </div>
          <div className="p-6 border-2 border-green-200 rounded-xl hover:border-green-500 bg-green-50/50 transition-colors">
            <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4">
            ...
            <p className="text-green-700">
              Comprehensive documentation, code examples, SDKs, JWT
              authentication, and dedicated support.
            </p>
          </div>
        </div>
      </section>
